...
export const concentricBands: Primitive = {
  ...
  defaultWeight: 0.5,
  render({ fg, bg, padding: p, accent }) {
    const k = (100 - 2 * p) / 251;
    const innerColor = accent ?? fg;
    ...
    const inner = `<path d="M125.5 171 C96.2289 171 72.5 147.271 72.5 118 L72.5 0 L178.5 0 L178.5 118 C178.5 147.271 154.771 171 125.5 171 Z" fill="${innerColor}" />`;
